...
import { deleteClass, deleteExam, deleteStudent, deleteSubject, deleteTeacher } from '@/lib/action';
...
const forms: {
    ...
    teacher: ( setOpen, type, data, relatedData) => (
        <TeacherForm type={type} data={data} setOpen={setOpen} relateData={relatedData} />
    ),
